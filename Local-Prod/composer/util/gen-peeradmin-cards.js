...
const   FABRIC_CA_CLIENT="../../local/fabric-ca/client/"
const   PROFILE_FOLDER="../../local/env/"
...
function genMetaData(org,peer){
    var name=peer+"PeerAdmin";
    var metadata={"version":1,"userName":"EventbritePeerAdmin","roles":["PeerAdmin","ChannelAdmin"]}
